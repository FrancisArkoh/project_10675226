...
using namespace std;
/*Project,Francis Arkoh_10675226*/
...
int main()
{
    ...
    newCourse[0].setCourse("Introduction to Algebra", "MATH 101");
    newCourse[1].setCourse("Information Management", "INFS 213");
    newCourse[2].setCourse("Introduction to Data Management system", " DMS 101");
    newCourse[3].setCourse("Information algorithm", "Info 221");
    newCourse[4].setCourse("Programming 1 c++", "CSCD 202");

    Staff newStaff[10];
    newStaff[0].setStaff("Mr.Anthony Micheals", "721010");
    newStaff[1].setStaff("Mr. Arkoh Francis  ", "2078541");
    newStaff[2].setStaff("Mr. Benard awuni", "19338");
    newStaff[3].setStaff("Mr. Augustus Yele", "10345");
    newStaff[4].setStaff("Mrs. Esenam Miriam", "806334");
